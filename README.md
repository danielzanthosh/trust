...
| `/config codex` | Start Codex OAuth if needed, show the login link, copy the code to clipboard, then import available Codex models |
| `/config codex code` | Reveal the last one-time code if clipboard paste fails |
